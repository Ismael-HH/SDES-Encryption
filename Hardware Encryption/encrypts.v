//============================================================
// SDES Encryption Module
//
// This module performs the SDES encryption process
// on an 8-bit plaintext input using two generated
// 8-bit subkeys.
//
// The encryption process follows these main steps:
//
// 1. Initial permutation of the plaintext
// 2. First Feistel round using key one
// 3. S-Box substitution and permutation
// 4. XOR with the left half of the data
// 5. Second Feistel round using key two
// 6. Final permutation to generate the ciphertext
//
...
always @(data)
	...
	// Step 3: XOR with First Subkey
		xorResult = four2EightScramble ^ keyOne;
	...
	// Step 7: Second Feistel Round using keyTwo
		...
		xorThreeResult = four2EightScrambleTwo ^ keyTwo;
